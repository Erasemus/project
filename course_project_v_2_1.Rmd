...
Results: The random forest prediction model demonstrated accuracy in excess of 99.69 % as determined by a confusion matrix generated against the cross validation data partition.
The out of sample error is .09% . In addition the kappa value of .9988 indicates a very high correlation of observed results to expect results. A plot of the random forest prediction model shows that the range of accuracy for the set of predictors chosen by the above methods is between 99% an 99.5% accuracy.
